from domain.entity import artifact_entity,config_entity
...
import numpy as np
from domain.config import TARGET_COLUMN
...
class DataValidation:
    ...
    def is_required_columns_exists(self,base_df:pd.DataFrame,current_df:pd.DataFrame,report_key_name:str)->bool:
        try:
            ...
            #base_df = base_df.drop(['domain_spf', 'asn_ip', 'qty_ip_resolved', 'ttl_hostname',
               #'tls_ssl_certificate', 'url_google_index', 'domain_google_index', 'url_shortened', 'domain_in_ip'],axis=1)
